...
class MetalFilter: CIFilter {
    ...
    func imageFromComputeShader(width width: CGFloat, height: CGFloat, inputImage: CIImage?) -> CIImage {
        ...
        for inputKey in inputKeys where (attributes[inputKey] as! Dictionary)[kCIAttributeClass] == "NSNumber" {
        ...
        for inputKey in inputKeys where (attributes[inputKey] as! Dictionary)[kCIAttributeClass] == "CIColor" {
            if let bufferIndex = (attributes[inputKey] as! [String:AnyObject])[kCIAttributeIdentity] as? Int,
